            ...
            <header class="header">
                <nav class="header__nav">
                    ...
                    <ul class="header__menu">
                        ...
                        <li class="header__menu__item">
                            <a href="boxshadow.html" class="header__menu__link">${header.menu.boxShadow}</a>
                        </li>
                        <li class="header__menu__item">
                            <a href="#" class="header__menu__link">${header.menu.textShadow}</a>
                        </li>
                        <li class="header__menu__item">
                            <a href="#" class="header__menu__link">${header.menu.button}</a>
                        </li>
                        <li class="header__menu__item">
                            <a href="#" class="header__menu__link">${header.menu.fontFace}</a>
                        </li>
                        <li class="header__menu__item">
                            <a href="#" class="header__menu__link">${header.menu.gradient}</a>
                        </li>
                        <li class="header__menu__item">
                            <a href="#" class="header__menu__link">${header.menu.transition}</a>
                        </li>
                        <li class="header__menu__item">
                            <a href="#" class="header__menu__link">${header.menu.colorPalets}</a>
                        </li>
                    </ul>
                    <div class="divider"></div>
